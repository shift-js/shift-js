                  ...
                  [
                    ...
                    {'Numbers and operations':
                      [
                        ...
                        'should handle unspaced operators',
                        'should handle order of operations',
                        'should handle comparisons',
                        'should handle preincrement',
                        'should handle postincrement',
                        'should handle unary operators',
                    ...
                    {'String interpolation':
                      [
                        ...
                        'should handle string interpolation with interpolation in middle of string',
                    ...
                    {'Nested collections':
                      [
                        ...
                        'should handle array access',
                        'should handle array access with numeric operations',
                        'should handle arrays of that contain a substring lookup',
                        'should handle arrays of dictionaries',
                   ...
                   {'If statements':
                    ...
                    {'While/Repeat-While loops':
                      [
                        ...
                        // 'should handle single-line repeat-while loops'
                      ]
                    }
                  ]
                  // ,
