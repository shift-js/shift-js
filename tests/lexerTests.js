...
describe('Lexer', function() {
  ...
  describe('Second milestone', function() {
    ...
    describe('Classes and Stuctures', function () {
      ...
      it('should handle basic instance method definitions and their invocation', function () {
      ...
      it('should handle basic instance method definitions with multiple parameter names and their invocation', function () {
        input = String.raw`class Counter {
                                var count = 0
                                func increment() {
                                    ++count
