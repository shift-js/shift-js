...
describe('Parser: First Milestone', function() {
  ...
  describe('Basic collections and constants', function () {
    ...
    */
    ...
    //    let http200StatusTuple = (statusCode: 200, description: "OK")'
    /** AST Explorer input
     function Tuple(tuple) {
      this.tup = {};
      if (Array.isArray(tuple)) {
     ...
     Tuple.prototype.constructor = Tuple;
     var errorTuple = new Tuple([404, 'not found']);
     var http200Status = new Tuple([{statusCode: 200}, {description: "OK"}]);
     */
    it('should handle more than one tuple in the source code', function() {
      input = [
        { type: "DECLARATION_KEYWORD",        value: "var" },
